...
! function(a, b) {
    ...
    m.fn = m.prototype = {
        ...
        for ("boolean" == typeof g && (j = g, g = arguments[h] || {}, h ++), "object" == typeof g || m.isFunction(g) || (g = {}), h === i && (g = this, h --); i > h; h ++)if (null != (e = arguments[h])) {
    ...
    function P(a) {
        var b;
        for (b in a)if (("data" !== b || ! m.isEmptyObject(a[b])) && "toJSON" !== b) {
            return ! 1;
        }
        return ! 0
    }
    ...
    function kc(a, b, c) {
        ...
        for (jc(k, j.opts.specialEasing); g > f; f ++)if (d = dc[f].call(j, a, k, j.opts)) {
            return d;
        }
