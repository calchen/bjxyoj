...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        echo "<span class=green>$MSG_Time_Limit: </span>$row->time_limit s&nbsp;&nbsp;";
        ...
        if (isset($_SESSION['administrator']))
        {
            ...
            [<a href="admin/problem_edit.php?id=<?php echo $id?>&getkey=<?php echo $_SESSION['getkey']?>">编辑</a>]
                                                                                                                [<a
            href="admin/quixplorer/index.php?action=list&dir=<?php echo $row->problem_id?>&order=name&srt=yes">测试数据</a>]
        <?php
        }
        echo "</center>";
