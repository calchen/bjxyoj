        ...
        <form action="register.php" method="post">
            ...
            <center>
                <table style="border-collapse: separate;border-spacing: 10px;">
                    <tr>
                        <td colspan=2 height=40 width=500
                            style="font-size: 150%;font-weight: bold;"><?php echo $MSG_REG_INFO ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><?php echo $MSG_REPEAT_PASSWORD ?>:</td>
                    ...
                    { ?>
                        <tr>
                            ...
                            <td style="display: inline;">
                                <input name="vcode" size=4 type=text style="width: 82%;display: inline;">
