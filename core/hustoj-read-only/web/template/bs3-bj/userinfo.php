...
<tr ><td width=15%><?php echo $MSG_Number?><td width=25% align=center><?php echo $Rank?><td width=70% align=center>已解决的问题</tr>
...
?><table border=1><tr class=toprow><td>用户名<td>密码<td>IP<td>时间</tr>
<tbody>
<?php
$cnt=0;
