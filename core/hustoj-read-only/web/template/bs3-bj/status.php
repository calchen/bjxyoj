...
<div class="container">
    ...
    <div class="jumbotron">
        <div align=center class="input-append">
            <?php
            ?>
            <form id=simform class=form-inline action="status.php" method="get" style="margin-bottom: 6px;">
                ...
                <?php echo $MSG_RESULT ?>:<select class="form-control" size="1" name="jresult">
                    ...
                    {
                        $i = ($j + 4) % 12;
                        if ($i == $jresult_get) echo "<option value='" . strval(
                                $jresult_get
                            ) . "' selected>" . $jresult[$i] . "</option>";
                ...
                <?php if (isset($_SESSION['administrator']) || isset($_SESSION['source_browser']))
                {
                    if (isset($_GET['showsim']))
                        ...
                        $showsim = 0;
                    echo "
                            SIM:<select style='margin-right: 2px;' id=\"appendedInputButton\" class=\"form-control\" name=showsim onchange=\"document.getElementById('simform').submit();\">
        ...
        <div id=center>
            <?php
            //echo "[<a href=status.php?" . $str2 . ">回到顶部</a>]&nbsp;&nbsp;";
            echo "[<a href=#" . $str2 . ">回到顶部</a>]&nbsp;&nbsp;";
            if (isset($_GET['prevtop']))
                echo "[<a href=status.php?" . $str2 . "&top=" . $_GET['prevtop'] . ">前一页</a>]&nbsp;&nbsp;";
            else
                echo "[<a href=status.php?" . $str2 . "&top=" . ($top + 20) . ">前一页</a>]&nbsp;&nbsp;";
