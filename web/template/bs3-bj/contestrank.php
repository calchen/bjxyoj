...
<div class="container">
    ...
    <div class="jumbotron">
        ...
        $rank = 1;
        ?>
        <center><h3>竞赛&作业 排行榜 - <?php echo $title ?></h3>
        ...
        <table id=rank>
            ...
            <tr class=toprow>
                ...
                <th style="text-align: center;width: 5%;">已解决</th>
                <th style="text-align: center;width: 8%;">惩罚</th>
                <?php
                for ($i = 0; $i < $pid_cnt; $i++)
                {
                    echo "<td style=\"text-align: center;\"><a style='color: #fff;' href=problem.php?cid=$cid&pid=$i>$PID[$i]</a></td>";
                }
                echo "</tr></thead>\n<tbody>";
