...
<div class="container">
    ...
    <div class="jumbotron">
        <center>
            <div>
                <h3>竞赛&作业 <?php echo $view_cid ?> - <?php echo $view_title ?></h3>

                <p><?php echo $view_description ?></p>
                <br>开始时间: <span style="color: #993399;"><?php echo $view_start_time ?></span>
                结束时间: <span style="color: #993399;"><?php echo $view_end_time ?></span><br>
                ...
                [<a href='contestrank.php?cid=<?php echo $view_cid ?>'>排行榜</a>]
